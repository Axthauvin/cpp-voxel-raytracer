...
namespace isim
{
    ...
    {
    public:
        Cuboid(const Point3 &min_point, const Point3 &max_point,
        ...
        Cuboid(const Point3 &center, float width, float height, float depth,
               Texture_material *material)
            : Cuboid(Point3(center.x - width / 2, center.y - height / 2,
                            center.z - depth / 2),
                     Point3(center.x + width / 2, center.y + height / 2,
                            center.z + depth / 2),
                     material)
        {}
        ...
        Point3 max_point;
        Point3 min_point;
        std::vector<Image_texture_material> face_materials;
