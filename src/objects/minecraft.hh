...
namespace isim
{
    ...
    public:
        ...
        Block(const Point3 &position, const char *top_texture_filename,
        ...
        Block(const Point3 &position, const char *top_texture_filename,
              const char *bottom_texture_filename,
              const char *side_texture_filename, Texture_material *mat,
              std::string block_type = "generic")
        ...
        Block(const Point3 &position, float width, float height, float depth,
        ...
        static Block water(const Point3 &position)
        {
            Uniform_texture_material *water_map = new Uniform_texture_material(
                Color::white, 1.0f, 0.2f, 255.0f, 1.3f);
        ...
        static Block *new_water(const Point3 &position, float width = 1,
                                float depth = 1)
        {
            Uniform_texture_material *water_map = new Uniform_texture_material(
                Color::white, 1.0f, 0.2f, 255.0f, 5.0f);
        ...
        {
            return Block(position, "textures/dirt/dirt.png",
        ...
        {
            return Block(position, "textures/sand/sand.png",
