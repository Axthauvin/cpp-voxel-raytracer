...
namespace isim
{
  ...
  Texture_properties Cuboid::getTextureCoordinatesAt(const Point3& point) const
  {
                            ...
                            const char* back_texture_filename)
  {
    ...
    face_materials.reserve(6);

    face_materials.push_back(
      Image_texture_material::get_cached(left_texture_filename));
    face_materials.push_back(
      Image_texture_material::get_cached(right_texture_filename));
    face_materials.push_back(
      Image_texture_material::get_cached(top_texture_filename));
    face_materials.push_back(
      Image_texture_material::get_cached(bottom_texture_filename));
    face_materials.push_back(
      Image_texture_material::get_cached(front_texture_filename));
    face_materials.push_back(
      Image_texture_material::get_cached(back_texture_filename));
  }
