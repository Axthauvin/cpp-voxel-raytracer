...
namespace isim
{
    ...
    public:
        ...
        virtual Color renderLight(const Texture_properties properties,
                                  float intensity, float specular_intensity,
    ...
    public:
        ...
        Color color;
        Color renderLight(const Texture_properties properties, float intensity,
                          float specular_intensity, Vector3 normal_at_collision,
    ...
    public:
        ...
        [[maybe_unused]] Color renderLight(
            ...
            [[maybe_unused]] Vector3 light_dir = Vector3(0, 0,
                                                         0)) const override
        {
            return Color(static_cast<uint8_t>(properties.ambient_color.r
                                              * this->intensity),
                         static_cast<uint8_t>(properties.ambient_color.g
                                              * this->intensity),
                         static_cast<uint8_t>(properties.ambient_color.b
                                              * this->intensity),
